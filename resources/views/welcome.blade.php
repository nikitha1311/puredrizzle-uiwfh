...
<div class="home-banner">
        ...
        <section id="slider-part" class="bg_cover slider-part-2" style="background-image: url(images/bg-3.jpg)">
            <div class="content-slied slick-initialized slick-slider"><span class="prev slick-arrow" style="display: block;"><i class="fa fa-angle-left"></i></span>
                ...
                </div><div class="single-slider d-flex align-items-center slick-slide slick-current slick-active" data-slick-index="1" aria-hidden="false" style="width: 1349px; position: relative; left: -1349px; top: 0px; z-index: 999; opacity: 1;" tabindex="0">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-11">
                                <div class="slider-content">
                ...
                </div><div class="single-slider d-flex align-items-center slick-slide" data-slick-index="2" aria-hidden="true" style="width: 1349px; position: relative; left: -2698px; top: 0px; z-index: 998; opacity: 0; transition: opacity 500ms ease 0s;" tabindex="-1">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-11">
                                <div class="slider-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2800px, 0px, 0px); transition: all 0.8s ease 0s; width: 7600px;"><div class="owl-item cloned" style="width: 400px;"><div class="col-lg-12">
                        ...
                        </div></div><div class="owl-item cloned" style="width: 400px;"><div class="col-lg-12">
                            <div class="singel-blog mt-30">
                                <div class="blog-thum">
                        ...
                        </div></div><div class="owl-item" style="width: 400px;"><div class="col-lg-12">
                            <div class="singel-blog mt-30">
                                <div class="blog-thum">
                                    <img src="images/blog/b-1.jpg" alt="Blog">
                                    <div class="date text-center">
                        ...
                        </div></div><div class="owl-item active" style="width: 400px;"><div class="col-lg-12">
                            <div class="singel-blog mt-30">
                                <div class="blog-thum">
                                    <img src="images/blog/b-3.jpg" alt="Blog">
                                    <div class="date text-center">
